...
## [1.19.0](https://github.com/upgreat-readable/pku/compare/v1.0.7...v1.19.0) (2022-07-14)
...
-   **logs:** сделал записи логов для мониторинга однострочными ([4259ee5](https://github.com/upgreat-readable/pku/commit/4259ee52ea208f560f60229e47c9a480122851ca))
...
-   **parameter date:** parameter date in sendlogs is optional now ([2335981](https://github.com/upgreat-readable/pku/commit/2335981e489ef692c866c294dce33c56769e71f8))
-   **psr node-ipc:** hardcode node-ipc version, update psr version ([12a429e](https://github.com/upgreat-readable/pku/commit/12a429e23e859d4b752370fd4cd976783b9e1750))
-   **psr:** update psr package ([a6d0d38](https://github.com/upgreat-readable/pku/commit/a6d0d3830016c3b871165c7144e3cb3fa90e2b4b))
...
-   **metrics:** подкорректировал метрики для прометея, сделал больше деталей Refs: CU-1pbvumc ([33d9182](https://github.com/upgreat-readable/pku/commit/33d918237a451cfa382f1d4a5b084a8620abf95a))
...
-   **muuid:** fix markup uuid ([1107180](https://github.com/upgreat-readable/pku/commit/1107180efb7aa2dde14d603b0f5a5bb1fa1f8208))
...
-   **uuid:** correct essay uuid ([fcb1cd3](https://github.com/upgreat-readable/pku/commit/fcb1cd37f659c0621c7d398625023ccd02fd0235))
