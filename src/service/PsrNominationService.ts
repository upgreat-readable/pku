//@ts-ignore
import { NominationsService } from '@upgreat-readable/psr';
import { FileCollection } from '../files/FileCollection';
import { File } from '../files/File';

// noinspection JSUnfilteredForInLoop
export class PsrNominationService {
    ...
    constructor(fileCollection: FileCollection) {
        ...
        this.readyObject = new NominationsService().calculate(readyToPsrEntity);
    }
